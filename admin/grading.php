...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?=$rootPage;?>.php"><i class="glyphicon glyphicon-list"></i>Grading</a></li>
      </ol>
    </section>
    ...
    <div class="box box-primary">
		...
		<label class="box-title">Grading List</label>
        ...
        <div class="box-tools pull-right">
          ...
          <?php
				...
				FROM persons dtl
				INNER JOIN division_positions dp ON dp.id=dtl.position_id AND dp.division_id=3
				WHERE 1 ";
        ...
        <div class="box-body">
           ...
           <?php
			...
			$sql.="ORDER BY dtl.fullname desc ";
