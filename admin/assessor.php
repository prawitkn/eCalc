...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
       ...
       Topic
        <small>Topics management</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?=$rootPage;?>.php"><i class="glyphicon glyphicon-list"></i>Topic List</a></li>
      </ol>
    </section>
    ...
    <div class="box box-primary">
		...
		<label class="box-title">Topic List</label>
        ...
        <div class="box-body">
			...
			<div class="row col-md-12">				
				<a href="<?=$rootPage;?>_add.php" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> Add Topic</a>
			</div>
			
           <?php
			$sql = "SELECT dtl.*
			, tg.name as topic_name 
			FROM topics dtl						
			LEFT JOIN topic_groups tg ON tg.id=dtl.topic_group_id 
			WHERE 1 ";
			if(isset($_GET['position_group_id'])) $sql.="AND dtl.position_group_id=:position_group_id "; 
