  ...
  <div class="content-wrapper">
	...
	<div class="col-md-12">				
	  ...
	  <div class="row col-md-12">
		<div class="col-md-2">
			<img  width="75" src="dist/img/<?php echo (empty($s_userPicture)? 'avatar5.png' : $s_userPicture) ?> " class="img-circle" alt="">
		</div>
		<div class="col-md-10">
			<h4><?=$row['code'].' : '.$row['fullname'];?></h4>
			<h4><?=$row['position_name'];?></h4>
		</div>
	  </div>
    </div>
